...
<body>
    <div class="container">
        <div class="navigation">
            ...
            <button onclick="window.location.href='report2-2.php'">การดาวน์โหลด</button>
            <button onclick="window.location.href='index.php'">หน้าหลัก</button>
        </div>

        <h2>ประวัติการค้นหา</h2>

        <form method="POST" action="report2.php" oninput="toggleDateInputs()">
            ...
            <div>
                ...
                <button type="reset" onclick="window.location.href='report2.php'">ล้าง</button>
            </div>
        </form>
